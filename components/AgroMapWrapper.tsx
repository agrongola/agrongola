...
const AgroMap = dynamic(() => import('./AgroMap'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full flex flex-col items-center justify-center bg-[#0a2e10]/80 backdrop-blur-sm text-white">
      <div className="w-12 h-12 border-4 border-[#76c893] border-t-transparent rounded-full animate-spin mb-4"></div>
